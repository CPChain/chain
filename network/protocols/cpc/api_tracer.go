...
import (
	...
	"bitbucket.org/cpchain/chain/network/protocols/cpc/tracers"
...
func (api *DebugManager) TraceChain(ctx context.Context, start, end rpc.BlockNumber, config *TraceConfig) (*rpc.Subscription, error) {
...
func (api *DebugManager) traceChain(ctx context.Context, start, end *types.Block, config *TraceConfig) (*rpc.Subscription, error) {
...
func (api *DebugManager) TraceBlockByNumber(ctx context.Context, number rpc.BlockNumber, config *TraceConfig) ([]*txTraceResult, error) {
...
// EVM and returns them as a JSON object.
func (api *DebugManager) TraceBlockByHash(ctx context.Context, hash common.Hash, config *TraceConfig) ([]*txTraceResult, error) {
...
func (api *DebugManager) TraceBlock(ctx context.Context, blob []byte, config *TraceConfig) ([]*txTraceResult, error) {
...
// EVM and returns them as a JSON object.
func (api *DebugManager) TraceBlockFromFile(ctx context.Context, file string, config *TraceConfig) ([]*txTraceResult, error) {
...
func (api *DebugManager) traceBlock(ctx context.Context, block *types.Block, config *TraceConfig) ([]*txTraceResult, error) {
...
func (api *DebugManager) computeStateDB(block *types.Block, reexec uint64) (*state.StateDB, error) {
...
func (api *DebugManager) computeStatePrivDB(block *types.Block) (*state.StateDB, error) {
	// If we have the state fully available, use that
...
// and returns them as a JSON object.
func (api *DebugManager) TraceTransaction(ctx context.Context, hash common.Hash, config *TraceConfig) (interface{}, error) {
...
// be tracer dependent.
func (api *DebugManager) traceTx(ctx context.Context, message core.Message, vmctx vm.Context, statedb *state.StateDB, config *TraceConfig) (interface{}, error) {
...
func (api *DebugManager) computeTxEnv(blockHash common.Hash, txIndex int, reexec uint64) (core.Message, vm.Context, *state.StateDB, error) {
	// Create the parent state database
