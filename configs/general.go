...
var (
	...
	AllCpchainProtocolChanges = &ChainConfig{big.NewInt(CpchainChainId), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, &DporConfig{Period: 0, Epoch: 4}}
