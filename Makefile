...
all: cpchain bootnode abigen smartcontract ecpubkey updateproxycontract testtool console reward-admin findimpeach
...
reward-admin:
	...
	@echo "Done building."
	@echo "Run \"$(GOBIN)/reward-admin\" to manage cpchain reward plan."
