...
func TestBasicCollector_GetRpt(t *testing.T) {
	...
	assert.Equal(t, float64(0), rpt.Rpt, "rpt value error")
}
...
func TestBasicCollector_GetRpts(t *testing.T) {
	...
	assert.Equal(t, float64(0), bc.GetRpts(&addresses, blockNum)[0].Rpt)
}
