...
# TODO change address
./cpchain-start-mainnet-validator.sh testmainnet

./cpchain-start-mainnet-proposer-1.sh testmainnet

./cpchain-start-mainnet-proposer-2.sh testmainnet

./cpchain-start-mainnet-proposer-3.sh testmainnet

./cpchain-start-mainnet-proposer-4.sh testmainnet

#./cpchain-start-mainnet-bank.sh

#./cpchain-start-mainnet-civilian.sh

./cpchain-start-mainnet-contract-admin.sh testmainnet
