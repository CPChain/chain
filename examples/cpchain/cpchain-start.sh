...
$cpchain $args --datadir data/data3  --rpcaddr 127.0.0.1:8503 --grpcaddr 127.0.0.1:8603 --gatewayaddr 127.0.0.1:8703 --port 30313 --mine \
         --unlock "0xef3dd127de235f15ffb4fc0d71469d1339df6465" --password conf/password1 2>data/logs/3.log &

$cpchain $args --datadir data/data4  --rpcaddr 127.0.0.1:8504 --grpcaddr 127.0.0.1:8604 --gatewayaddr 127.0.0.1:8704 --port 30314 --mine \
         --unlock "0x3a18598184ef84198db90c28fdfdfdf56544f747" --password conf/password2 2>data/logs/4.log &

$cpchain $args --datadir data/data5  --rpcaddr 127.0.0.1:8505 --grpcaddr 127.0.0.1:8605 --gatewayaddr 127.0.0.1:8705 --port 30315 --mine \
         --unlock "0x6e31e5b68a98dcd17264bd1ba547d0b3e874da1e" --password conf/password 2>data/logs/5.log &

$cpchain $args --datadir data/data6  --rpcaddr 127.0.0.1:8506 --grpcaddr 127.0.0.1:8606 --gatewayaddr 127.0.0.1:8706 --port 30316 --mine \
         --unlock "0x22a672eab2b1a3ff3ed91563205a56ca5a560e08" --password conf/password 2>data/logs/6.log &

$cpchain $args --datadir data/data7  --rpcaddr 127.0.0.1:8507 --grpcaddr 127.0.0.1:8607 --gatewayaddr 127.0.0.1:8707 --port 30317 --mine \
         --unlock "0x7b2f052a372951d02798853e39ee56c895109992" --password conf/password 2>data/logs/7.log &

$cpchain $args --datadir data/data8  --rpcaddr 127.0.0.1:8508 --grpcaddr 127.0.0.1:8608 --gatewayaddr 127.0.0.1:8708 --port 30318 --mine \
         --unlock "0x2f0176cc3a8617b6ddea6a501028fa4c6fc25ca1"  --password conf/password 2>data/logs/8.log &

$cpchain $args --datadir data/data9  --rpcaddr 127.0.0.1:8509 --grpcaddr 127.0.0.1:8609 --gatewayaddr 127.0.0.1:8709 --port 30319 --mine \
         --unlock "0xe4d51117832e84f1d082e9fc12439b771a57e7b2"  --password conf/password 2>data/logs/9.log &

$cpchain $args --datadir data/data10  --rpcaddr 127.0.0.1:8510 --grpcaddr 127.0.0.1:8610 --gatewayaddr 127.0.0.1:8710 --port 30320 --mine \
