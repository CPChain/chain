...
# validator
nohup $cpchain $args --ipcaddr ${ipc_path_base}7 --datadir data/data7  --rpcaddr 0.0.0.0:8507 --port 30317 --mine \
...
nohup $cpchain $args --ipcaddr ${ipc_path_base}8 --datadir data/data8  --rpcaddr 0.0.0.0:8508 --port 30318 --mine \
...
nohup $cpchain $args --ipcaddr ${ipc_path_base}9 --datadir data/data9  --rpcaddr 0.0.0.0:8509 --port 30319 --mine \
...
nohup $cpchain $args --ipcaddr ${ipc_path_base}10 --datadir data/data10  --rpcaddr 0.0.0.0:8510 --port 30320 --mine \
...
nohup $cpchain $args --ipcaddr ${ipc_path_base}11 --datadir data/data11 --rpcaddr 0.0.0.0:8511 --port 30321 --mine \
...
nohup $cpchain $args --ipcaddr ${ipc_path_base}12 --datadir data/data12 --rpcaddr 0.0.0.0:8512 --port 30322 --mine \
...
nohup $cpchain $args --ipcaddr ${ipc_path_base}13 --datadir data/data13 --rpcaddr 0.0.0.0:8513 --port 30323 --mine \
