...
// the Free Software Foundation, either version 3 of the License, çor
...
//go:generate abigen --sol ./dpor/contracts/proposer/proposer_register.sol --pkg proposer --out ./dpor/contracts/proposer/proposer_register.go
