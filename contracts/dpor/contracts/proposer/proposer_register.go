...
const ProposerRegisterABI = "[{\"constant\":true,\"inputs\":[{\"name\":\"\",\"type\":\"address\"}],\"name\":\"_publicKeys\",\"outputs\":[{\"name\":\"\",\"type\":\"bytes\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"name\":\"viewIndex\",\"type\":\"uint256\"},{\"name\":\"otherAddress\",\"type\":\"address\"}],\"name\":\"getNodeInfo\",\"outputs\":[{\"name\":\"\",\"type\":\"bytes\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"rsaPublicKey\",\"type\":\"bytes\"}],\"name\":\"registerPublicKey\",\"outputs\":[],\"payable\":true,\"stateMutability\":\"payable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"name\":\"addr\",\"type\":\"address\"}],\"name\":\"getPublicKey\",\"outputs\":[{\"name\":\"\",\"type\":\"bytes\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"viewIndex\",\"type\":\"uint256\"},{\"name\":\"otherAddress\",\"type\":\"address\"},{\"name\":\"encrpytedNodeInfo\",\"type\":\"bytes\"}],\"name\":\"addNodeInfo\",\"outputs\":[],\"payable\":true,\"stateMutability\":\"payable\",\"type\":\"function\"},{\"inputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"}]"

// ProposerRegisterBin is the compiled bytecode used for deploying new contracts.
const ProposerRegisterBin = ``

// DeployProposerRegister deploys a new cpchain contract, binding an instance of ProposerRegister to it.
...
// ProposerRegister is an auto generated Go binding around an cpchain contract.
...
// ProposerRegisterCaller is an auto generated read-only Go binding around an cpchain contract.
type ProposerRegisterCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ProposerRegisterTransactor is an auto generated write-only Go binding around an cpchain contract.
type ProposerRegisterTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ProposerRegisterFilterer is an auto generated log filtering Go binding around an cpchain contract events.
type ProposerRegisterFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ProposerRegisterSession is an auto generated Go binding around an cpchain contract,
...
// ProposerRegisterCallerSession is an auto generated read-only Go binding around an cpchain contract,
...
// ProposerRegisterTransactorSession is an auto generated write-only Go binding around an cpchain contract,
...
// ProposerRegisterRaw is an auto generated low-level Go binding around an cpchain contract.
type ProposerRegisterRaw struct {
	Contract *ProposerRegister // Generic contract binding to access the raw methods on
}

// ProposerRegisterCallerRaw is an auto generated low-level read-only Go binding around an cpchain contract.
...
// ProposerRegisterTransactorRaw is an auto generated low-level write-only Go binding around an cpchain contract.
...
func (_ProposerRegister *ProposerRegisterCaller) PublicKeys(opts *bind.CallOpts, arg0 common.Address) ([]byte, error) {
	var (
		ret0 = new([]byte)
	)
	out := ret0
	err := _ProposerRegister.contract.Call(opts, out, "_publicKeys", arg0)
	return *ret0, err
}
...
//
// Solidity: function _publicKeys( address) constant returns(bytes)
func (_ProposerRegister *ProposerRegisterSession) PublicKeys(arg0 common.Address) ([]byte, error) {
	return _ProposerRegister.Contract.PublicKeys(&_ProposerRegister.CallOpts, arg0)
}

// PublicKeys is a free data retrieval call binding the contract method 0x2c76beff.
//
// Solidity: function _publicKeys( address) constant returns(bytes)
func (_ProposerRegister *ProposerRegisterCallerSession) PublicKeys(arg0 common.Address) ([]byte, error) {
	return _ProposerRegister.Contract.PublicKeys(&_ProposerRegister.CallOpts, arg0)
}
...
func (_ProposerRegister *ProposerRegisterCaller) GetNodeInfo(opts *bind.CallOpts, viewIndex *big.Int, otherAddress common.Address) ([]byte, error) {
	var (
		ret0 = new([]byte)
	)
	out := ret0
	err := _ProposerRegister.contract.Call(opts, out, "getNodeInfo", viewIndex, otherAddress)
	return *ret0, err
}
...
//
// Solidity: function getNodeInfo(viewIndex uint256, otherAddress address) constant returns(bytes)
func (_ProposerRegister *ProposerRegisterSession) GetNodeInfo(viewIndex *big.Int, otherAddress common.Address) ([]byte, error) {
	return _ProposerRegister.Contract.GetNodeInfo(&_ProposerRegister.CallOpts, viewIndex, otherAddress)
}

// GetNodeInfo is a free data retrieval call binding the contract method 0x36056b40.
//
// Solidity: function getNodeInfo(viewIndex uint256, otherAddress address) constant returns(bytes)
func (_ProposerRegister *ProposerRegisterCallerSession) GetNodeInfo(viewIndex *big.Int, otherAddress common.Address) ([]byte, error) {
	return _ProposerRegister.Contract.GetNodeInfo(&_ProposerRegister.CallOpts, viewIndex, otherAddress)
}
...
func (_ProposerRegister *ProposerRegisterTransactor) AddNodeInfo(opts *bind.TransactOpts, viewIndex *big.Int, otherAddress common.Address, encrpytedNodeInfo []byte) (*types.Transaction, error) {
	return _ProposerRegister.contract.Transact(opts, "addNodeInfo", viewIndex, otherAddress, encrpytedNodeInfo)
}

// AddNodeInfo is a paid mutator transaction binding the contract method 0xf9438991.
//
// Solidity: function addNodeInfo(viewIndex uint256, otherAddress address, encrpytedNodeInfo bytes) returns()
func (_ProposerRegister *ProposerRegisterSession) AddNodeInfo(viewIndex *big.Int, otherAddress common.Address, encrpytedNodeInfo []byte) (*types.Transaction, error) {
	return _ProposerRegister.Contract.AddNodeInfo(&_ProposerRegister.TransactOpts, viewIndex, otherAddress, encrpytedNodeInfo)
}

// AddNodeInfo is a paid mutator transaction binding the contract method 0xf9438991.
//
// Solidity: function addNodeInfo(viewIndex uint256, otherAddress address, encrpytedNodeInfo bytes) returns()
func (_ProposerRegister *ProposerRegisterTransactorSession) AddNodeInfo(viewIndex *big.Int, otherAddress common.Address, encrpytedNodeInfo []byte) (*types.Transaction, error) {
	return _ProposerRegister.Contract.AddNodeInfo(&_ProposerRegister.TransactOpts, viewIndex, otherAddress, encrpytedNodeInfo)
}
