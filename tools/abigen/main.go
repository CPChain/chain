...
var (
	abiFlag = flag.String("abi", "", "Path to the Cpchain contract ABI json to bind, - for STDIN")
	binFlag = flag.String("bin", "", "Path to the Cpchain contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Cpchain contract Solidity source to build and bind")
