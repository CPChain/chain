...
func configNode(ctx *cli.Context, n *node.Node, cfg *node.Config) {
}

func configChain(ctx *cli.Context, node *node.Node, cfg *eth.Config) {
...
func configAllandCreate(ctx *cli.Context, cfg *config) *node.Node {
