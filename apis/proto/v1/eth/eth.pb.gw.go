...
/*
Package ethpb is a reverse proxy.
...
var (
	pattern_PublicInnerEthereumAPI_GasPrice_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"apis", "v1", "eth", "gasPrice"}, ""))

	pattern_PublicInnerEthereumAPI_ProtocolVersion_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"apis", "v1", "eth", "protocolVersion"}, ""))

	pattern_PublicInnerEthereumAPI_Syncing_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"apis", "v1", "eth", "syncing"}, ""))
)
