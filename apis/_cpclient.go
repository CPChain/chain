...
func NewCpcClient(c *grpc.ClientConn) *CpcClient {
	return &CpcClient{c}
}

func Dial(rawurl string) (*CpcClient, error) {
	return DialContext(context.Background(), rawurl)
}

func DialContext(ctx context.Context, rawurl string) (*CpcClient, error) {
	cli, err := grpc.DialContext(context.Background(), rawurl)
	if err != nil {
		return nil, err
	}
	return NewCpcClient(cli), nil
}
...
func (c *CpcClient) BlockByHash(ctx context.Context, hash common.Hash) (*types.Block, error) {
	return c.getBlock(ctx, "/protos.Cpc/GetBlockByHash", hash, true)
}
...
func (c *CpcClient) BlockByNumber(ctx context.Context, number *big.Int) (*types.Block, error) {
	return c.getBlock(ctx, "/protos.Cpc/GetBlockByNumber", toBlockNumArg(number), true)
}
...
func (c *CpcClient) getBlock(ctx context.Context, method string, args ...interface{}) (*types.Block, error) {
	var result json.RawMessage
	// c.c.Invoke(ctx context.Context, method string, args, reply interface{}, opts ...CallOption)
	// "/PackageName.ServiceName/MethodName"
	err := c.c.Invoke(ctx, method, args, &result)
	if err != nil {
		return nil, err
	} else if len(result.Hash) == 0 {
...
func (c *CpcClient) HeaderByHash(ctx context.Context, hash common.Hash) (*types.Header, error) {
	var head *types.Header
	var req &prots.type
	err := c.c.Invoke(ctx, "/protos.Cpc/GetBlockByHash", args, &result)
	if err == nil && head == nil {
