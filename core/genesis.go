...
type Genesis struct {
	...
	ExtraData1 []byte              `json:"extraData1"`
...
func DefaultCpchainGenesisBlock() *Genesis {
	return &Genesis{
		...
		ExtraData1: hexutil.MustDecode(""),
		GasLimit:   4700000,
		Difficulty: big.NewInt(1),
