...
// Package cpchain provides a client for the Cpchain RPC API.
package cpclient
...
func (c *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, cpchain.NotFound
...
func (c *Client) SyncProgress(ctx context.Context) (*cpchain.SyncProgress, error) {
	var raw json.RawMessage
...
func (c *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (cpchain.Subscription, error) {
...
func (c *Client) FilterLogs(ctx context.Context, q cpchain.FilterQuery) ([]types.Log, error) {
...
func (c *Client) SubscribeFilterLogs(ctx context.Context, q cpchain.FilterQuery, ch chan<- types.Log) (cpchain.Subscription, error) {
	return c.c.EthSubscribe(ctx, ch, "logs", toFilterArg(q))
}

func toFilterArg(q cpchain.FilterQuery) interface{} {
...
func (c *Client) CallContract(ctx context.Context, msg cpchain.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (c *Client) PendingCallContract(ctx context.Context, msg cpchain.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (c *Client) EstimateGas(ctx context.Context, msg cpchain.CallMsg) (uint64, error) {
