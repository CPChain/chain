...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (cpchain.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q cpchain.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q cpchain.FilterQuery, ch chan<- types.Log) (cpchain.Subscription, error) {
...
func (ec *Client) PendingCallContract(ctx context.Context, msg cpchain.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) EstimateGas(ctx context.Context, msg cpchain.CallMsg) (uint64, error) {
