...
func (*StatusInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_txpool_9f2000d7d35b8d80, []int{0}
}
...
func (*Dump) Descriptor() ([]byte, []int) {
	return fileDescriptor_txpool_9f2000d7d35b8d80, []int{1}
}
...
func (*NonceTx) Descriptor() ([]byte, []int) {
	return fileDescriptor_txpool_9f2000d7d35b8d80, []int{2}
}
...
func (*AccountNonceTxPool) Descriptor() ([]byte, []int) {
	return fileDescriptor_txpool_9f2000d7d35b8d80, []int{3}
}
...
func (dst *AccountNonceTxPool) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AccountNonceTxPool.Merge(dst, src)
}
...
func (*TxPool) Descriptor() ([]byte, []int) {
	return fileDescriptor_txpool_9f2000d7d35b8d80, []int{4}
}
...
func (dst *TxPool) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TxPool.Merge(dst, src)
}
...
func (*NonceTxString) Descriptor() ([]byte, []int) {
	return fileDescriptor_txpool_9f2000d7d35b8d80, []int{5}
}
...
func (dst *NonceTxString) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NonceTxString.Merge(dst, src)
}
...
func (*AccountNonceTxStringPool) Descriptor() ([]byte, []int) {
	return fileDescriptor_txpool_9f2000d7d35b8d80, []int{6}
}
...
func (dst *AccountNonceTxStringPool) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AccountNonceTxStringPool.Merge(dst, src)
}
...
func (*TxStringPool) Descriptor() ([]byte, []int) {
	return fileDescriptor_txpool_9f2000d7d35b8d80, []int{7}
}
...
func (dst *TxStringPool) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TxStringPool.Merge(dst, src)
}
...
func init() { proto.RegisterFile("v1/txpool/txpool.proto", fileDescriptor_txpool_9f2000d7d35b8d80) }

var fileDescriptor_txpool_9f2000d7d35b8d80 = []byte{
