...
func (*StatusInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_txpool_11370c0e45149fbd, []int{0}
}
...
func (*Dump) Descriptor() ([]byte, []int) {
	return fileDescriptor_txpool_11370c0e45149fbd, []int{1}
}
...
func (*NonceTx) Descriptor() ([]byte, []int) {
	return fileDescriptor_txpool_11370c0e45149fbd, []int{2}
}
...
func (*AccountNonceTxPool) Descriptor() ([]byte, []int) {
	return fileDescriptor_txpool_11370c0e45149fbd, []int{3}
}
...
func (*TxPool) Descriptor() ([]byte, []int) {
	return fileDescriptor_txpool_11370c0e45149fbd, []int{4}
}
...
func (*NonceTxString) Descriptor() ([]byte, []int) {
	return fileDescriptor_txpool_11370c0e45149fbd, []int{5}
}
...
func (*AccountNonceTxStringPool) Descriptor() ([]byte, []int) {
	return fileDescriptor_txpool_11370c0e45149fbd, []int{6}
}
...
func (*TxStringPool) Descriptor() ([]byte, []int) {
	return fileDescriptor_txpool_11370c0e45149fbd, []int{7}
}
...
func init() { proto.RegisterFile("v1/txpool/txpool.proto", fileDescriptor_txpool_11370c0e45149fbd) }

var fileDescriptor_txpool_11370c0e45149fbd = []byte{
