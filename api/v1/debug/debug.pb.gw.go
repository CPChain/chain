...
var (
	pattern_DebugManager_Preimage_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"apis", "v1", "debug", "preimage"}, ""))

	pattern_DebugManager_GetBadBlocks_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"apis", "v1", "debug", "getBadBlocks"}, ""))

	pattern_DebugManager_StorageRangeAt_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"apis", "v1", "debug", "storageRangeAt"}, ""))

	pattern_DebugManager_GetModifiedAccountsByNumber_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"apis", "v1", "debug", "getModifiedAccountsByNumber"}, ""))

	pattern_DebugManager_GetModifiedAccountsByHash_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"apis", "v1", "debug", "getModifiedAccountsByHash"}, ""))
)
